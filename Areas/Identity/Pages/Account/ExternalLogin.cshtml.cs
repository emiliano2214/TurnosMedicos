...
namespace TurnosMedicos.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        private UsuarioExt CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(UsuarioExt)}'. " +
                    $"Ensure that '{nameof(UsuarioExt)}' is not an abstract class and has a parameterless constructor, or alternatively " +
